              ...
              <div class="sidebar_widget">
                ...
                <form method="post">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" rows="1" class="form-control" id="priceperkm" name="price" disabled placeholder="  <?php echo htmlentities($ppKMs = $result->PricePerKM); ?>"> <?php ($ppKMs); ?> </input>
                  </div>

                  <div class="form-group">
                    <label>Approximate total:</label>
                    <input type="text" rows="1" class="form-control" name="total" id="approxtot"  placeholder="<?php echo htmlentities($gtotal = $tdistance * $ppKMs); ?>"> <?php ($gtotal); ?> </input>
                  </div>


                  <div class="form-group">
                    <label>total:</label>
                    <input type="text" rows="1" class="form-control" name="total" disabled placeholder="<?php echo htmlentities($gtotal = $tdistance * $ppKMs); ?>"> <?php ($gtotal); ?> </input>
                  </div>
