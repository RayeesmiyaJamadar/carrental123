...
?>
													...
													<div class="stat-panel-number h1 "><?php echo htmlentities($yatra_id);?></div>
														<div class="stat-panel-title text-uppercase">Yatra_Special</div>
												</div>
											</div>
											<a href="view-yatra.php" class="block-anchor panel-footer text-center">Full Detail &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
...
?>
													...
													<div class="stat-panel-number h1 "><?php echo htmlentities($bookings);?></div>
													<div class="stat-panel-title text-uppercase">Total Yatra Bookings</div>
												</div>
											</div>
											<a href="manageyatra-bookings.php" class="block-anchor panel-footer text-center">Full Detail &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
								</div>
							</div>
